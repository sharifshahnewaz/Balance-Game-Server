...
public class BodySourceView : MonoBehaviour
{
    ...
    private GameObject CreateBodyObject(ulong id)
    {
        ...
        for (Kinect.JointType jt = Kinect.JointType.SpineBase; jt <= Kinect.JointType.HandRight; jt++)
        {
            ...
            jointObj.GetComponent<Renderer>().enabled = true;
    ...
    void OnApplicationQuit()
    {
        ...
        System.IO.File.AppendAllText(gameController.resourceFile+"-joint-data-" + fileId.ToString() + ".csv", jointDataRecorder.ToString());
    }
}
